package net.tenth.purifyall.block.entity.renderer;
...
public class PurifierBlockEntityRenderer implements BlockEntityRenderer<PurifierBlockEntity> {
    public PurifierBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(PurifierBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        switch (pBlockEntity.getBlockState().getValue(PurifierBlock.FACING)) {
