...
public class PurifierMenu extends AbstractContainerMenu {
    ...
    public PurifierMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.PURIFIER_MENU.get(), id);
        // ITS IMPORTANT YOU MAKE SURE THIS PMINSIZE MATCHES THE ITEMSTACKHANDLER NUMBER IN THE ENTITY CLASS
        // AND TE_INVENTORY_SLOT_COUNT
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.PURIFIER.get());
    }
